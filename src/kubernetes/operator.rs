...
impl KubernetesOperator {
    ...
    pub fn is_pod_disruption_safe(spec: &HNSQRClusterSpec, ready_replicas: u32, disrupting_count: u32) -> bool {
    ...
    pub fn reconcile_scale(
        ...
        if spec.replicas > status.ready_replicas {
            ...
            actions.push(format!("Provision {needed} new learner pods for data catch-up"));
            ...
            actions.push(format!("Demote {excess} voting members to learners via Raft"));
