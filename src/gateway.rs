...
//!
//! ## Key Capabilities
//! - **Pairwise Complex Isometric Folding:** Losslessly maps $2d$-dim real floats to $d$-dim complex vectors in one allocation, preserving $\text{Re}\langle\Phi(x),\Phi(y)\rangle = x^\top y$.
...
use crate::metadata_index::{FilterExpr, MetadataValue};
use crate::{
